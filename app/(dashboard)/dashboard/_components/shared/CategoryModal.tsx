...
const CategoryModal = ({
	...
	return (
		<Dialog open={showModal}>
			{editcategory ? (
				<DialogContent className='bg-black !border-white/10 !text-dark-2'>
					...
					<DialogDescription className='flex items-start justify-between flex-col'>
						<p className='title text-dark-2 text-base'>
							selected category
						</p>
						{category ? (
							<div
				...
				<DialogContent className='bg-black !border-white/10 '>
					<DialogHeader>
						<DialogTitle className='title text-dark-2 flex w-full items-center justify-between'>
							Item category{" "}
