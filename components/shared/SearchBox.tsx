...
const SearchBox = () => {
	return (
		<div className='flex w-full justify-end items-center px-2 p-1 border rounded-3xl border-purple-300 shadow-sm shadow-black/10 gap-4'>
			<MagnifyingGlassIcon className='w-4 lg:w-6 h-4 lg:h-6 text-black-2' />
			<input
