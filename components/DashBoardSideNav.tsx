...
const DashBoardSideNav = () => {
	...
	return (
		<section className='w-[200px] bg-[#17171f] h-full py-4'>
			<aside className='w-full p-2 text-center flex flex-col gap-4'>
				<Link href={"/"}>
					<h2 className='title !text-secondary cursor-pointer'>
						Gura Gurisha
					</h2>
				</Link>
				<nav className=' py-5 '>
					<div className=' pb-4 px-2 flex w-full justify-between items-center relative'>
						...
						<p className='bg-purple-500 h-7 flex text-center justify-center font-bold text-purple-100 w-7 rounded-full absolute top-0 right-4 cursor-pointer ScaleAnimation'>
							10
						</p>
					</div>
